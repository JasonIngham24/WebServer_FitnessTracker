...
<template>
  <main>
    <div v-if="!session.user" class="notification is-primary">
      ...
      <p>Log in to access your activities, view your friends' activities, and check your statistics.</p>
    </div>

    <div v-if="session.user" class="notification is-primary fixed-grid has-1-cols">
